...
For detailed explanation of these options, refer to our [API reference](https://pspdfkit.com/api/reference/document-engine/upstream/#tag/Digital-Signatures/operation/sign-document)
...
```
curl -X 'POST' 'http://localhost:5000/api/documents/7KPS3D7YT4JQ8PAJ3DWJ0Q28H8/sign' \
  -H 'Accept: application/json' \
  -H 'Authorization: Token token="secret"' \
  -H 'Content-Type: application/json' \
  -d '{
